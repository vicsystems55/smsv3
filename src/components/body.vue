    ...
    <div class="page-wrapper" :class="layoutobj">
      ...
      <div class="page-body-wrapper">
        ...
        <div class="sidebar-wrapper" :class="[{ close_icon : !togglesidebar }]" :sidebar-layout="layout.settings.sidebar_setting">
          ...
          <AdminSidebar  @clicked="sidebar_toggle" />
          <!-- <AdminSidebar v-if="role=='admin'" @clicked="sidebar_toggle" /> -->

          <!-- <JudgeSidebar v-if="role=='judge'" @clicked="sidebar_toggle" />
          <ParticipantSidebar v-if="role=='participant'" @clicked="sidebar_toggle" />
          <MentorSidebar v-if="role=='mentor'" @clicked="sidebar_toggle" /> -->
...
<script>
  ...
  import JudgeSidebar from './judge_sidebar.vue';
  import ParticipantSidebar from './participant_sidebar.vue';
  import MentorSidebar from './mentor_sidebar.vue';
